...
public class TestImatge {
    public static void main(String[] args) {
        ...
        BufferedImage img2 = img.deepCopy();
        
        for (int l = 0; l < img.getNumTeseles(16); l++) {
            Integer[] pos = img.getPosTesela(l, 16);
            img2.setRGB(pos[0], pos[1], new Color(0, 0, 0).getRGB());
        }
